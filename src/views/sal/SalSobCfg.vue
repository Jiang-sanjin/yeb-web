  ...
  <div>
    <div>
      <el-input prefix-icon="el-icon-search" placeholder="请输入员工名进行搜索..." v-model="empName"
        @keydown.enter.native="dosearch" clearable @clear="initEmps" style="width: 300px;margin-right: 10px">
      </el-input>
      <el-button type="primary" icon="el-icon-search" @click="dosearch">搜索
      </el-button>
      <el-table :data="emps" border stripe size="mini" style="margin-top:10px">
        <el-table-column type="selection" align="left" width="55">
        </el-table-column>
        <el-table-column prop="name" label="姓名" fixed align="left" width="120">
        </el-table-column>
        <el-table-column prop="workID" label="工号" align="left" width="120">
        </el-table-column>
        <el-table-column prop="email" label="电子邮件" align="left" width="200">
        </el-table-column>
        ...
        <el-table-column label="操作" align="center">
          <template slot-scope="scope">
            <!-- 弹出框 -->
            <el-popover placement="left" @show="showPop(scope.row.salary)" @hide="hidePop(scope.row)" title="编辑工资账套"
