...
<template>
  <div>
    <div style="display: flex;justify-content: space-between">
      <el-button type="primary" icon="el-icon-plus" @click="showAddSalaryView">添加工资账套
      </el-button>
      ...
      <el-table :data="salaries" border stripe>
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            <el-button type="primary" @click="showEditSalaryView(scope.row)">编辑
            </el-button>
            <el-button type="danger" @click="deleteSalary(scope.row)">删除
            </el-button>
          </template>
        </el-table-column>
      </el-table>
