  ...
  <div>
      ...
      <div style="display: flex;justify-content: space-between">
        <div>
          <el-input prefix-icon="el-icon-search" placeholder="请输入员工名进行搜索..." v-model="empName"
            @keydown.enter.native="initEmps" clearable @clear="initEmps" :disabled="showAdvanceSearchVisible"
        ...
        <div>
          <!-- 导入数据 -->
          <el-upload action="/system/basic/employee/import" :before-upload="beforeUpload" :headers="headers"
          ...
          <el-row style="margin-top: 10px">
            <el-col :span="5">
              ...
              <el-popover placement="right" title="请选择部门" width="200" trigger="manual" v-model="popVisible2">
                ...
                <div slot="reference" style="width: 130px;display: inline-flex;
                        ...
                        margin-left: 3px" @click="showDepView2">
                  {{inputDepName}}
                </div>
              </el-popover>
            </el-col>
            <el-col :span="10">
              入职日期:
              <el-date-picker v-model="searchValue.beginDateScope" size="mini" type="daterange"
            ...
            <el-col :span="5" :offset="4">
              ...
              <el-button type="primary" @click="initEmps('advanced')">搜索
              </el-button>
            </el-col>
          </el-row>
        </div>
    ...
    <div style="margin-top: 10px">
      <el-table :data="emps" stripe border v-loading="loading" element-loading-text="正在加载..."
        ...
        <el-table-column prop="birthday" align="left" width="95" label="出生日期">
        </el-table-column>
        <el-table-column prop="idCard" align="left" width="150" label="身份证号码">
        </el-table-column>
        ...
        <el-table-column prop="email" align="left" width="180" label="电子邮件">
        </el-table-column>
        <el-table-column prop="phone" align="left" width="100" label="电话号码">
        </el-table-column>
        <el-table-column prop="address" align="left" width="220" label="联系地址">
        </el-table-column>
        ...
        <el-table-column prop="workState" align="left" width="70" label="在职状态">
        </el-table-column>
        <el-table-column prop="beginDate" align="left" width="95" label="入职日期">
        </el-table-column>
        <el-table-column prop="conversionTime" align="left" width="95" label="转正日期">
        </el-table-column>
        <el-table-column prop="beginContract" align="left" width="95" label="合同起始日期">
        </el-table-column>
        <el-table-column prop="endContract" align="left" width="95" label="合同截止日期">
        </el-table-column>
      ...
      <div style="display: flex;justify-content: flex-end">
        ...
        :current-page.sync="currentPage" @size-change="sizeChange"
            ...
            <el-col :span="6">
              <el-form-item label="所属部门：" prop="departmentId">
                ...
                <el-popover placement="right" title="请选择部门" width="200" trigger="manual" v-model="popVisible">
                  <el-tree :data="allDeps" :props="defaultProps" default-expand-all @node-click="handleNodeClick">
                  </el-tree>
            ...
            <el-col :span="6">
              <el-form-item label="合同截止日期：" prop="endContract">
                <el-date-picker v-model="emp.endContract" size="mini" type="date" value-format="yyyy-MM-dd"
                  style="width: 130px" placeholder="合同截止日期">
                </el-date-picker>
              </el-form-item>
            </el-col>
          </el-row>
